...
# @Bruno de momento solo he copiado pyrttov_example.py y voy a meter modificaciones a partir del script
...
rttov_installdir = '/home/bruno/Desktop/RTTOV/'

mhs_data_path='/home/bruno/Downloads/MHSL1_20240521T021851Z_20240521T040051Z_epct_fa2babab_F.h5'
ecmwf_data_path='/home/bruno/Downloads/ECMWF/ECMWF_20240521_00+02.grib'

mhs_data=prepare_data.prepare_MHS_data(mhs_data_path)
ecmwf_data=prepare_data.prepare_ECMWF_data(ecmwf_data_path)
...
if __name__ == '__main__':
    ...
    nlevels = len(ecmwf_data['t'])
    nprofiles = len(ecmwf_data['t'])
    ...
    myProfiles.P = ecmwf_data['p']
    myProfiles.T = ecmwf_data['t']
    # Modify the temperature of the second profile
    #myProfiles.T[1, :] += 2
    myProfiles.Q = ecmwf_data['q']
    myProfiles.CO2 = ex.co2_ex
    ...
    try:
        ...
        #urfemisrefl_seviri[1,:,:] = brdfAtlas.getEmisBrdf(seviriRttov)
